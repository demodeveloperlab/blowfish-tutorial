...
<div class="relative w-screen max-w-[1600px] px-[30px]" style="left: calc(max(-50vw,-800px) + 50%);">
      <div class="mx-auto max-w-xl text-center text-center">
        <h1 class="mb-8 font-extrabold text-primary-600 dark:text-primary-400" style="font-size:4.5rem">
          ...
          <h2 class="mb-8 text-4xl font-extrabold">template for Astro 4.0 + Tailwind CSS
          </h2>
  ...
  <div class="flex">
    <div class="mr-4 mt-8">
      <span class="flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-primary-600 dark:bg-primary-500 text-neutral-50 shadow-xl">
       <svg class="w-8 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
...
<div class="max-w-6xl mx-auto grid gap-8 sm:grid-cols-2">
...
<p class="text-xl">
  ...
  <div class="relative">
      <img
        class="inset-0 object-cover object-bottom rounded-full w-full w-96 h-96 shadow-lg"
        src="https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
        alt=""
      />
    </div>
